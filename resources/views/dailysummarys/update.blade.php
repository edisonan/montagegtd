...
@section('content')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            getInfos('{{ $dailysummary->summary_date }}');
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" rows="4" name="work_content"
                                      id="dailysummary-workcontent">{{ $dailysummary->work_content }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" rows="4" name="life_content"
                                      id="dailysummary-lifecontent">{{ $dailysummary->life_content }}</textarea>
                        </div>
                    </div>
