                ...
                <div class="card">
                    ...
                    <form action="{{ url('/dailysummary') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
	                                <input type="text" name="summary_date" id="dailysummary-summarydate" class="form-control" value="{{ $summary_date }}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
				<textarea class="form-control" rows="4"  name="work_content" id="dailysummary-workcontent" ></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
				<textarea class="form-control" rows="4"  name="life_content" id="dailysummary-lifecontent" ></textarea>
                            </div>
                        </div>
