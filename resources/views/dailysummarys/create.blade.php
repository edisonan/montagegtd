                ...
                <div class="card">
                    ...
                    <form action="{{ url('/dailysummary') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
	                                <input type="text" name="summary_date" id="dailysummary-summarydate" class="form-control" value="{{ $summary_date }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
	                                <input type="text" name="work_content" id="dailysummary-workcontent" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
	                                <input type="text" name="life_content" id="dailysummary-lifecontent" class="form-control" value="">
                            </div>
                        </div>
