    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="card">
            <div class="p-4 border-b border-gray-200">
                <div class="font-semibold text-gray-900">我的兑换订单</div>
            </div>
            <div class="p-4">
                <div id="orderList" class="space-y-3 text-sm text-gray-700">
                    <div class="text-gray-500">加载订单中...</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function renderOrders(orders) {
            ...
            if (!orders || !orders.length) {
                container.innerHTML = '<div class="text-gray-500">暂无兑换订单</div>';
                return;
            }
