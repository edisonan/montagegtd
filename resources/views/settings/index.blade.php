                ...
                <!-- New Task Form -->
                    ...
                    <!-- Task Name -->
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="day_pomo_goal" id="day_pomo_goal" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="week_pomo_goal" id="week_pomo_goal" class="form-control"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="month_pomo_goal" id="month_pomo_goal" class="form-control"
                        ...
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pomo_time" id="pomo_time" class="form-control"
                        ...
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="pomo_rest_time" id="pomo_rest_time" class="form-control"
                        ...
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="kindle_email" id="kindle_email" class="form-control"
                        ...
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="ifttt_notify" id="ifttt_notify" class="form-control"
                        ...
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="is_start_kindle" id="inlineRadio1"
                                       value="0" {{ empty($setting->is_start_kindle) ?'checked':'' }}><span>不开启</span>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_start_kindle" id="inlineRadio2"
                                       value="1" {{ $setting->is_start_kindle == 1 ?'checked':'' }}><span>开启</span>
                            </label>
                        </div>
                        <div class="form-group row" id="task_form_div1">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="with_image_push" id="inlineRadio1"
                                       value="0" {{ empty($setting->with_image_push) ?'checked':'' }}><span>不开启</span>
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="with_image_push" id="inlineRadio2"
                                       value="1" {{ $setting->with_image_push == 1 ?'checked':'' }}><span>开启</span>
                            </label>
                        </div>
