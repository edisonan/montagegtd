        ...
        function loadArticle(articleSubId) {
            ...
            request('/articles/explorer/data/articles/' + encodeURIComponent(articleSubId))
                .done(function (result) {
                    ...
                    html += '<button type="button" class="action-btn js-artifact-open" data-article-id="' + articleIdNum + '" data-artifact-type="ai_ppt" title="AIPPT"><i class="fas fa-file-powerpoint"></i><span class="action-label">AIPPT</span></button>';
