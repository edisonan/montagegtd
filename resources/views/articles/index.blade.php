            ...
            function renderArticleList(articleSubs) {
                ...
                articleSubs.forEach(function(articleSub) {
                    ...
                    html += ''
                        ...
                        + '<button type="button" class="action-btn js-artifact-open" data-article-id="' + articleId + '" data-artifact-type="mind_map" title="AI思维导图"><i class="fas fa-brain"></i><span class="action-label">思维导图</span></button>'
                        + '<button type="button" class="action-btn js-artifact-open" data-article-id="' + articleId + '" data-artifact-type="ai_ppt" title="AIPPT"><i class="fas fa-file-powerpoint"></i><span class="action-label">AIPPT</span></button>'
                        + '<div class="share-container"><button type="button" class="action-btn share-btn" title="分享"><i class="fas fa-share-alt"></i><span class="action-label">分享</span></button><div class="share-menu"><a href="javascript:void(0);" class="share-option icon-heart" data-id="' + articleId + '"><i class="fas fa-heart"></i><span>记录笔记</span></a></div></div>'
