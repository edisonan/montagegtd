								...
								<div class="card" style="margin-bottom:10px">
									<div class="card-block" style="padding: 10px;">
									  ...
									  <p class="card-text text-right">
											...
											<a href="javascript:void(0);"  article_sub_id="{{$articleSub->id}}" class="btn btn-outline-primary set_read_later @if($articleSub->status == 'read_later') active @endif"><img src="/img/icon/read_later.png" width="30px"/>Read Later</a>
											<a href="javascript:void(0);"  article_sub_id="{{$articleSub->id}}" class="btn btn-outline-primary set_read @if($articleSub->status == 'read') active @endif"><img src="/img/icon/read_already.png" width="30px"/>Read</a>
											<a href="javascript:void(0);"  article_sub_id="{{$articleSub->id}}" class="btn btn-outline-primary set_star @if($articleSub->status == 'star') active @endif"><img src="/img/icon/read_star.png" width="30px"/>Star</a>
