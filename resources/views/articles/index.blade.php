...
$(document).ready(function () {
        ...
        $(".post-text").click(function(){
                $count = parseInt($(this).attr('click_count'));
                if($count+1%3 == 0){
                        $(this).attr('click_count', 0);

                        height=$(this).height();
                        height=$(document).scrollTop()-$(window).height()-$(this).offset().top;
                        $(this).css("height",height);
                        $(this).css("overflow","hidden");
                        $(this).after("<p class=\"morecon\" style=\"align-text: right;text-align: right; color: #337ab7; cursor:pointer; font-size: 2em; \">click for more content...</p>");
                        $(this).parent().find(".view-all").css("display","");
                } else {
                        $(this).attr('click_count', $count+1);
                }
        });
        ...
        $(".view-all").on('click',function(){
                ...
                if($.cookie("unable_img2") != null && $.cookie("unable_img2")=="true"){
                        $(this).parent().parent().parent().find(".post-text img").each(function(){
                                if($(this).attr("orignal_src") != null && $(this).attr("orignal_src")!="" && $(this).attr("src") == "/img/unable_img.png") {
        ...
        $("#unable_img2").on('click',function(){
                if($("#unable_img2").is(':checked')){
                        $.cookie('unable_img2', true);
                } else {
                        $.cookie('unable_img2', false);
                }
                location.href="";
        });
        //处理屏蔽图片
        ...
        } else if($.cookie("unable_img") != null && $.cookie("unable_img")=="true"){
                ...
                <div class=" col-md-8">
                        <div class="card card-default">
                                <div class="card-header">
                                        ...
                                        <div style="float: right">
                                                ...
                                                <input type="checkbox" value="" id="unable_img2" />智能屏图 
                    ...
                    @include('common.errors')
                                ...
                                <div class="card-block" style="padding: 10px;">
                                        ...
                                        <div class="card-text post-text" click_count="0" img_count=0>
                                                                                <?php
