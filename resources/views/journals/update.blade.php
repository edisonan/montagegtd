...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="card overflow-hidden mb-6">
            <div class="px-6 py-5 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-white">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 class="text-xl font-bold text-gray-900">修改手账记录</h2>
                            <p class="text-sm text-gray-500 mt-1">编辑您已完成的手账信息</p>
                        </div>
                    </div>
                    <a href="{{ '/journals' }}" class="btn btn-outline btn-sm">
            ...
            <div class="p-6">
                ...
                <!-- 编辑表单 -->
                <form action="javascript:void(0);" method="POST" class="space-y-6" id="journal-update-form">

                    <!-- 手账内容 -->
                    <div class="space-y-2">
                        <label for="name" class="block text-sm font-medium text-gray-700">
                            <span class="text-red-500 mr-1">*</span>手账内容
                        </label>
                        <div class="relative">
                            <input
                                    type="text"
            ...
            <div class="p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div class="p-3 bg-gray-50 rounded-lg">
                        ...
                        <p class="text-xs text-gray-600">系统会自动计算手账耗时并显示</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function loadJournalDetail() {
            ...
            currentJournalId = getJournalIdFromPath();
            if (!currentJournalId) {
                showErrorToast('无法识别手账ID');
                return;
            }
            apiRequest('GET', '/journals/' + currentJournalId, {}).then(function(resp) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 表单验证
            const form = document.getElementById('journal-update-form');
            form.addEventListener('submit', function(event) {
                ...
                apiRequest('PUT', '/journals/' + currentJournalId, {
                    name: nameInput.value.trim(),
                    start_time: startTimeInput.value,
                    end_time: endTimeInput.value
                }).then(function(resp) {
                    if (resp && resp.code === 9999) {
                        window.location.href = '{{ url('/journals') }}';
                        return;
                    }
