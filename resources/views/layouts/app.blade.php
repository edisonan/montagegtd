...
<head>
    ...
    <title>@yield('title','蒙太奇 - 有知有行')</title>
...
<div class="container" style="    margin-bottom: 5px;">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<script src="/js/popper.min.js?version=1.11.0" crossorigin="anonymous"></script>
		
	    @yield('content')
	
	    <!-- JavaScripts -->
	     <script src="/js/bootstrap.min.js?version=4.0.0-beta" crossorigin="anonymous"></script>
