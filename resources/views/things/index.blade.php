    ...
    <div class="container">
        <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <div class="time-control-group">
                                    <button type="button" class="btn btn-outline-secondary quick-time-btn" data-minutes="10">刚刚10分钟</button>
                                    <button type="button" class="btn btn-outline-secondary quick-time-btn" data-minutes="25">25分钟前</button>
                                    <button type="button" class="btn btn-outline-secondary quick-time-btn" data-minutes="60">1小时前</button>
                                    <button type="button" class="btn btn-outline-secondary quick-time-btn" data-minutes="120">2小时前</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-10 offset-md-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-btn fa-check"></i> 提交记录
                                </button>
                                <button type="button" class="btn btn-outline-secondary" onclick="setDefaultTimes()">
                                    <i class="fa fa-btn fa-clock"></i> 重置为现在
                                </button>
                            </div>
                        </div>
                    </form>
            ...
            <div class="card" style="margin-top: 10px;">
                <div class="card-header">新完成事情记录</div>
                <div class="card-body">
                    @if (count($things) > 0)
