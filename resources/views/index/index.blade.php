            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    @if($runing_pomo_status == 2 || $runing_pomo_status == 4 )
                    	<a class="btn btn-lg btn-outline-secondary btn-shadow btn-block" href="javascript:void(0)" role="button" id = "divdown" onclick="discard()" ></a>
                    @elseif($runing_pomo_status == 1)
                   		 <a class="btn btn-lg btn-outline-secondary btn-shadow btn-block" href="{{url('pomos/start')}}" role="button" > 开始一个新的番茄吧! </a>
                    @endif
