            ...
            <div class="card">
                ...
                <div class="card-body row">
					...
					<div id="" class=" col-md-4">
						...
						<textarea  class="col-md-12" id="mind_content" data-toolbarHeaderL="[['bold']]" onfocus="mind_content_focus()" style="margin: 0px; height: 189px; " id="mind_content">{{$mind->content}}</textarea>
