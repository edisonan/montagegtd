...
class CategoryRepository {
	 ...
	 * @return unknown
	 */
	public function getUserCategoryById($userId, $id) {
	 ...
	 * @return unknown
	 */
	public function getUserCategoryByName($userId, $name) {
		return Category::where ( 'user_id', $userId )->where ( 'name', $name )->first ();
	}
