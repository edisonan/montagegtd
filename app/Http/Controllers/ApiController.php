...
//     	$user = $request->user();
    	...
    	$sql = 'select b.subject as title,b.published as publieshed,b.id as article_id,c.id as feed_id,c.feed_name as feed_name from article_subs a,articles b,feeds c where a.user=:user_id and a.article_id = b.id and b.feed_id = c.id and status=:status';
