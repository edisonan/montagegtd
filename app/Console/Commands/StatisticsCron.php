...
class StatisticsCron extends Command
{
    ...
    public function handle()
    {
    	...
    	foreach ($article_counts as $count_info){
    		$param_arr = ['user_id'=>$count_info['user_id'], 'data_type' => 'article', 'date_type' => $date_type, 'statistic_date' => $start_time];
    	...
    	foreach ($mind_counts as $count_info){
    		$param_arr = ['user_id'=>$count_info['user_id'], 'data_type' => 'mind', 'date_type' => $date_type, 'statistic_date' => $start_time];
